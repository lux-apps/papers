...
The economics around it are legible and unflattering. MOR trades at \$1.58, a market
capitalization near \$14M, with 24-hour volume of \$57,314 \prov{verified}. Tradeable DEX
liquidity is about \$1.32M, most of it owned by the protocol itself \prov{verified}. Real
...
The concentration facts, read from chain on 2026-08-29 (market figures as of 2026-09-18), presented as risks to
depositors rather than as accusations of intent. Existing supply is 9,286,960 MOR (Base 63\%,
Arbitrum 36\%, Ethereum under 1\%) \prov{verified}. Price is \$1.58, market capitalization
\$14.32M, 24-hour volume \$57,314, down 65.2\% on the year and 98.9\% from the all-time high
...
DEX liquidity is about \$1.32M, most of it protocol-owned, with a protocol-owned-liquidity
Safe holding 99.98\% of the main pool's active liquidity \prov{verified}. Daily volume is about 4\%
of liquidity; a \$100,000 sell equals nearly two days of total market volume \prov{derived}.
...
(ADOPT-08). An order-book venue deepens a book that is mostly protocol-owned (ADOPT-06).
...
is $EP \approx 12{,}050 \times \$1.58 \approx \$19{,}040$/day \prov{derived}. At $f = 1\%$,
net-deflationary needs gross fee-bearing volume $Ac > \$1.90$M/day, about \$695M/year
\prov{illustrative}. At $f = 5\%$, above \$139M/year; at $f = 10\%$, above \$70M/year. Against
...
demand. The float is thin (depth about \$1.3M, mostly protocol-owned, 24h volume about \$57k
...
ADOPT-06 named the venue problem and the order-book fix: a book that is mostly protocol-owned,
...
book that is mostly protocol-owned (ADOPT-06). Deploy LMOR self-repaying credit against the idle
